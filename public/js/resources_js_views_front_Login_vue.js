...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  setup: function setup(__props, _ref) {
    ...
    expose();
    var __returned__ = {
      useAuth: _services_authServices_js__WEBPACK_IMPORTED_MODULE_0__["default"]
    };
...
var _hoisted_2 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<h1 class=\"text-center text-3xl font-semibold text-gray-700 dark:text-white\"> Se Connecter </h1><p class=\"mt-2 text-center font-light text-gray-500 dark:text-gray-400\"> Connectez-vous pour accéder à votre compte </p><form class=\"mt-6\"><div><label for=\"username\" class=\"block text-sm text-gray-800 dark:text-gray-200\">E-mail</label><input type=\"email\" required class=\"mt-2 block w-full rounded-md border bg-white px-4 py-2 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:focus:border-blue-300\"></div><div class=\"mt-4\"><div class=\"flex items-center justify-between\"><label for=\"password\" class=\"block text-sm text-gray-800 dark:text-gray-200\">Mot de passe</label><a href=\"#\" class=\"text-xs text-blue-500 hover:underline dark:text-gray-400\">Mot de passe oublié ?</a></div><input type=\"password\" required class=\"mt-2 block w-full rounded-md border bg-white px-4 py-2 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:focus:border-blue-300\"></div><div class=\"mt-6\"><button class=\"w-full transform rounded-md bg-blue-500 px-4 py-2 tracking-wide text-white transition-colors duration-200 hover:bg-blue-700 focus:bg-blue-500 focus:outline-none\"> Se Connecter </button></div></form>", 3);

var _hoisted_5 = {
  "class": "mt-8 text-center text-xs font-light text-gray-400"
};

var _hoisted_6 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Vous n'avez pas de compte ? ");

var _hoisted_7 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("S'inscrire");

function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_router_link = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("router-link");

  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("section", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [_hoisted_2, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_5, [_hoisted_6, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    to: {
      name: 'register'
    },
...
;
const __exports__ = /*#__PURE__*/(0,C_laragon_www_gestionformation_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_Login_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Login_vue_vue_type_template_id_560c5e34__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/views/front/Login.vue"]])
/* hot reload */
if (false) {}
