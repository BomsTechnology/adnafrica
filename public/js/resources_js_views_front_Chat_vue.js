...
var _hoisted_12 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"flex h-24 w-full items-center space-x-2 border-l-4 border-b border-l-primary-color bg-gray-50 p-3\"><div class=\"h-12 w-12 overflow-hidden rounded lg:h-16 lg:w-16\"><img src=\"/images/ads/cuisine/1.jpg\" class=\"h-full w-full bg-cover object-cover\" alt=\"\"></div><div class=\"shrink\"><h1 class=\"whitespace-normal text-sm font-bold\"> Boms </h1><h6 class=\"whitespace-normal text-xs font-semibold text-gray-800\"> Gâteau à la crème chocolat </h6></div><div class=\"flex grow items-center justify-end\"><input id=\"checkbox-all-search\" type=\"checkbox\" class=\"dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600 h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500\"></div></div><div class=\"flex h-24 w-full items-center space-x-2 border-b p-3\"><div class=\"h-12 w-12 overflow-hidden rounded lg:h-16 lg:w-16\"><img src=\"/images/ads/cuisine/2.jpg\" class=\"h-full w-full bg-cover object-cover\" alt=\"\"></div><div class=\"shrink\"><h1 class=\"whitespace-normal text-sm font-bold\"> Thomas </h1><h6 class=\"whitespace-normal text-xs font-semibold text-gray-800\"> Gâteau chocolat </h6></div><div class=\"flex grow items-center justify-end\"><input id=\"checkbox-all-search\" type=\"checkbox\" class=\"dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600 h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500\"></div></div>", 2);
...
var _hoisted_21 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"grow overflow-auto\"><div class=\"flex h-24 w-full items-center space-x-2 border-l-4 border-b border-l-primary-color bg-gray-50 p-3\"><div class=\"h-12 w-12 overflow-hidden rounded lg:h-16 lg:w-16\"><img src=\"/images/ads/cuisine/1.jpg\" class=\"h-full w-full bg-cover object-cover\" alt=\"\"></div><div class=\"shrink\"><h1 class=\"whitespace-normal text-sm font-bold\"> Boms </h1><h6 class=\"whitespace-normal text-xs font-semibold text-gray-800\"> Gâteau à la crème chocolat </h6></div><div class=\"flex grow items-center justify-end\"><input id=\"checkbox-all-search\" type=\"checkbox\" class=\"dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600 h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500\"></div></div><div class=\"flex h-24 w-full items-center space-x-2 border-b p-3\"><div class=\"h-12 w-12 overflow-hidden rounded lg:h-16 lg:w-16\"><img src=\"/images/ads/cuisine/2.jpg\" class=\"h-full w-full bg-cover object-cover\" alt=\"\"></div><div class=\"shrink\"><h1 class=\"whitespace-normal text-sm font-bold\"> Thomas </h1><h6 class=\"whitespace-normal text-xs font-semibold text-gray-800\"> Gâteau chocolat </h6></div><div class=\"flex grow items-center justify-end\"><input id=\"checkbox-all-search\" type=\"checkbox\" class=\"dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600 h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500\"></div></div></div>", 1);
