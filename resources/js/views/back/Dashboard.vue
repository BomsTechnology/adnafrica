...
<template>
    <div class="h-full p-8">
        ...
        <div class="flex h-full flex-col space-y-4">
            <div class="mt-4 grid grid-cols-2 gap-8 lg:grid-cols-4">
                <div
                ...
                >
                    <div><QuestionMarkCircleIcon class="h-12 w-12" /></div>
                    <div class="text-center text-2xl font-bold">
                        <h2></h2>
                        <h1>Faqs</h1>
                    </div>
            ...
            <div class="grow space-y-8 py-8 lg:flex lg:space-x-8 lg:space-y-0">
                <div
                    class="h-full w-full overflow-auto rounded-lg bg-white shadow"
                ></div>
                <div
                    class="h-full w-full overflow-auto rounded-lg bg-white shadow"
                ></div>
